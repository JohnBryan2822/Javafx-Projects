...
import application.logic.events.EventType;
...
//		System.out.println("Game Over!");
	...
	public void newGame() {
        ...
        alert.setTitle("Restarting the Game");
	...
	private void resetTheGame() {
		timeLine.stop();
		gamePanel.getChildren().removeAll();
	    // Reset the game state in the GameController
		eventLister.resetGame(new MoveEvent(EventType.DOWN, EventSource.USER));
	    
	    // Update the UI as needed
	    gameOverPanel.setVisible(false);
	    isGameOver.setValue(false);
	    pauseButton.setText("Pause");
	    pauseButton.selectedProperty().set(false);
	}
	
	private void setTheGamePanel() {
