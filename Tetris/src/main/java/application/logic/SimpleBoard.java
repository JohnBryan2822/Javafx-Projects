...
import application.logic.bricks.Brick;
import application.logic.bricks.RandomBrickGenerator;
...
public class SimpleBoard {
	...
	public boolean createNewBrick() {
		...
		printMatrix(currentBrick.getBrickMatrix().get(0));
...
//		return true;
	...
	public ClearRow clearAllRows() {
		ClearRow clearRow = MatrixOperations.removeAll(currentGameMatrix);
		currentGameMatrix = clearRow.getNextMatrix();
		return clearRow;
	}
}
